...
const services = [
	{
		...
		icon: <Layers size={32} />,
		desc: "Build systems tailored to your business needs, including management platforms, workflow automation, and internal tools. We have delivered solutions such as Constra Construction Management System (for project, resource, and finance management), Zyra SACCO Management System (for SACCO/member management, loans, and reporting), and more.",
		benefits: ["Efficiency, scalability, and seamless integration."],
		example: "Constra Construction Management System, Zyra SACCO Management System, Custom business platforms",
	},
	{
		title: "POS & Inventory Systems",
		icon: <ShoppingCart size={32} />,
		desc: "Streamlined solutions for retail, pharmacies, and small businesses. Our Sentra POS System is designed for shops and supermarkets, while Lypha Pharmacy System is tailored for pharmacies, providing inventory, sales, and reporting tools.",
		benefits: ["Stock management, sales tracking, real-time analytics."],
		example: "Sentra POS System, Lypha Pharmacy System",
	},
	{
		title: "School Management Systems",
		icon: <BookOpen size={32} />,
		desc: "Full-featured academic administration platforms. DRAIS School Management System covers attendance, grading, reporting, and parent communication for schools.",
		benefits: ["Attendance, grading, reporting, parent communication."],
		example: "DRAIS School Management System",
	},
	{
		title: "Web & Mobile Development",
		icon: <MonitorSmartphone size={32} />,
		desc: "Modern, responsive websites and mobile apps for businesses, organizations, and startups. We create scalable, cross-platform solutions to boost your digital presence.",
	...
	},
	{
		...
		desc: "Automate repetitive tasks and integrate existing systems for improved efficiency. We connect your business tools and enable seamless data flow.",
	...
	},
	{
		...
		desc: "Intuitive, visually appealing interfaces for web and mobile. Our design team ensures your platforms are user-friendly and engaging.",
