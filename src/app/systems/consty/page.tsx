...
import { ArrowRight, CheckCircle, Briefcase, Users, BarChart3, Shield } from "lucide-react";
import Link from "next/link";
import Navbar from "../../../components/Navbar";
import Footer from "../../../components/Footer";

const features = [
	{ icon: <Briefcase className="w-8 h-8" />, title: "Project Planning", description: "Comprehensive planning, scheduling, and timeline management" },
	{ icon: <Users className="w-8 h-8" />, title: "Resource Management", description: "Allocate and track resources across multiple projects" },
	{ icon: <BarChart3 className="w-8 h-8" />, title: "Budget Control", description: "Monitor budgets and costs in real-time" },
	{ icon: <Shield className="w-8 h-8" />, title: "Quality Assurance", description: "Track quality metrics and compliance standards" },
];

export default function CONSTYPage() {
	return (
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<div className="inline-flex items-center gap-3 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full mb-6">
							<span className="text-blue-700 dark:text-blue-300 font-semibold">Construction Management</span>
						</div>
						<h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6">
							CONSTY
						</h1>
						<p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
							End-to-end construction project management system for optimal control and delivery.
						</p>
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							...
							<motion.a
								href="https://consty-demo.xhenvolt.com"
								target="_blank"
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
							Why Construction Teams Choose CONSTY
						</h2>
					</motion.div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						{[
							...
							"Track resources and equipment efficiently",
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
							Master Your Construction Projects
						</h2>
						<p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
							Join construction companies across East Africa delivering successful projects with CONSTY.
						</p>
						<motion.div
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
