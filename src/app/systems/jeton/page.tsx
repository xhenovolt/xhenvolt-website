...
const features = [
	{ icon: <Boxes className="w-8 h-8" />, title: "Business Executive System", description: "Track operations, valuation, networth, shares and all other company related information with our powerful executive operating system" },
...
export default function JETONPage() {
	return (
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<div className="inline-flex items-center gap-3 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full mb-6">
							<span className="text-blue-700 dark:text-blue-300 font-semibold">Company execution</span>
						</div>
						<h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6">
							JETON
						</h1>
						<p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
							Powerful execution system for companies of all sizes.
						</p>
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						...
						<p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
							Everything for modern company operations
						</p>
					</motion.div>
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
							Why Companies Choose JETON
						</h2>
					</motion.div>

					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						{[
							"Realtime company valuation",
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						...
						<p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
							Join companies across East Africa using JETON to grow their businesses efficiently.
						</p>
						<motion.div
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
