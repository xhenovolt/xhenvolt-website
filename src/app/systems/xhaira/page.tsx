...
import { ArrowRight, CheckCircle, Wallet, Users, TrendingUp, Lock } from "lucide-react";
import Link from "next/link";
import Navbar from "../../../components/Navbar";
import Footer from "../../../components/Footer";

const features = [
	{ icon: <Wallet className="w-8 h-8" />, title: "Member Accounts", description: "Manage member contributions, savings, and account balances" },
	{ icon: <Users className="w-8 h-8" />, title: "Loan Management", description: "Streamlined loan application, approval, and repayment tracking" },
	{ icon: <TrendingUp className="w-8 h-8" />, title: "Financial Reports", description: "Comprehensive reporting and financial analytics" },
	{ icon: <Lock className="w-8 h-8" />, title: "Security", description: "Enterprise-grade security for member data and transactions" },
];

export default function XHAIRAPage() {
	return (
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<div className="inline-flex items-center gap-3 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full mb-6">
							<span className="text-blue-700 dark:text-blue-300 font-semibold">SACCO Management</span>
						</div>
						<h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6">
							XHAIRA
						</h1>
						<p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
							Complete financial management solution for SACCOs and cooperative institutions.
						</p>
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						...
						<p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
							Comprehensive SACCO financial management
						</p>
					</motion.div>
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					>
						<h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
							Strengthen Your SACCO Today
						</h2>
						<p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
							Join SACCOs across East Africa building member trust with XHAIRA.
						</p>
						<motion.div
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
